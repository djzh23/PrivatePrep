> Diese Datei ist eine archivierte Version der README aus dem Zustand vor dem
> V1-Refactor im September 2026. Sie beschreibt den ursprünglichen Full-Scope
> Prototyp mit 5 AI-Modi, CV Studio, RAG und Redis Dual-Storage. Der Code dieser
> Version liegt im Branch archive/v0-legacy-2026-09-17 und ist unter dem Tag
> v0-legacy sowie als GitHub Release verfügbar.
>
> Für die aktuelle V1-Beschreibung siehe README.md im Repo-Root.
